...
class Reinforce(PolicyGradientLearner):
    ...
    def calculateGradient(self):
      ...
      #  print "Hello",returns,seqidx,self.dataset,self.dataset.getNumSequences()
        ...
        baselines = mean(loglhs ** 2 * returns, 0) / mean(loglhs ** 2, 0.000000001)
        # TODO: why gradient negative?
        gradient = -mean(loglhs * (returns - baselines), 0)
      #  print "Gradient ",self.dataset
        return gradient
